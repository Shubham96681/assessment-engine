...
def build_rag_uniqueness_block(
    ...
    *,
    ...
    from app.generation.chapter_prompt_config import (

        suggested_givens_lines,

        uniqueness_role_chain,

    )



    ch = (chapter or "circles").strip().lower()

    role_chain = uniqueness_role_chain(

        ch, full_hard=full_hard, ui_difficulty="hard"
