"""
Build GATE reference vector index (question stems by chapter).

Usage (from backend/):
  python scripts/build_gate_reference_index.py [--force]
"""
...
async def main() -> None:
    ...
    man = await build_gate_reference_index(force=args.force)
